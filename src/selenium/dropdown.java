...
public class dropdown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement un2= driver.findElement(By.xpath("//a[@href='#'][normalize-space()='Software Testing']"));

		a.moveToElement(un2).perform();
		
		 Thread.sleep(1000);
		 
		WebElement un3= driver.findElement(By.xpath("//a[normalize-space()='Manual Testing']"));
		un3.click();

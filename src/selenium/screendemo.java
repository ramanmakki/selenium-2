...
public class screendemo {
	...
	private static final File arc = null;
    ...
    //  File arc =ts.getScreenshotAs(OutputType.FILE);		
		Thread.sleep(2000);
	//	driver.getTitle();
		...
		File dest=new File("C:\\Users\\raman\\Downloads\\out.png");
		FileUtils.copyFile(arc, dest);
		Thread.sleep(2000);
		postclick.click();		

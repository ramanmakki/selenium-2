...
public class dropdown4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement un2= driver.findElement(By.xpath("//a[@href='#'][normalize-space()='Digital Marketing']"));
		a.moveToElement(un2).perform();
		
		Thread.sleep(3000);
		 
		WebElement un3= driver.findElement(By.xpath("//a[@class='has'][normalize-space()='Digital Marketing']"));
		un3.click();
	}

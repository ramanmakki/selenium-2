...
public class dropdown6 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement un2= driver.findElement(By.xpath("//a[normalize-space()='Network & Security']"));
		a.moveToElement(un2).perform();
		
		Thread.sleep(2000);
		 
		WebElement un3= driver.findElement(By.xpath("//a[normalize-space()='Cyber Security']"));
		un3.click();
